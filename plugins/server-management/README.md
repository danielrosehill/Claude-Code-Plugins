...
# CC-Plugin-server-management

Claude Code plugin for server-management slash commands and agents.

## Installation

```bash
/plugin marketplace add danielrosehill/CC-Plugin-server-management
