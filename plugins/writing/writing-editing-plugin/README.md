...
# CC-Plugin-writing-editing

Claude Code plugin for writing-editing slash commands and agents.

## Installation

```bash
/plugin marketplace add danielrosehill/CC-Plugin-writing-editing
