...
# CC-Plugin-claude-code

Claude Code plugin for claude-code slash commands and agents.

## Installation

```bash
/plugin marketplace add danielrosehill/CC-Plugin-claude-code
/plugin install claude-code@danielrosehill
```
